...
<body>
	<table align="center" border="0" bgcolor="#fdfcf8" cellpadding="0" cellspacing="0" width="600" style="font-family:Verdana, Geneva, sans-serif;font-size:12px;color:#3f3d3c">
        ...
        <tr>
        	<td>
            	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="background:url(<?php echo base_url(); ?>img/liston_costuras.jpg) repeat-x;font-size:12px;" height="60px">
                    ...
                    <tr>
                    	<td style="color:#ffffff; padding:0 40px 10px 40px;">Hemos recibido tu solicitud de pedido de catálogos.  Tu número de pedido es: <strong><?php echo $folio_catalogo; ?></strong></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
        	<td style="padding:20px 40px;">Estos fueron los catálogos que pediste</td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td style="padding:10px 40px 5px 40px;">Los datos de contacto que proporcionaste son:</td>
        </tr>
        <tr>
