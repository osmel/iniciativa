        ...
        <div id="contenido">
            <div id="detalle">
                <span class="img_destacada">
                    <?php
                        switch ($producto->tipo_producto) {
                            case 1:
                                echo '<span class="producto-nuevo prod-liston-detalle"></span>';
                                break;
                            case 2:
                                echo '<span class="producto-oferta prod-liston-detalle"></span>';
                                break;
                        }
                    ?>
                ...
                <span class="info_producto">
                    ...
                    <?php if ($producto->metros_rollo) : ?><span class="descripcion_producto"><?php echo "Rollo de: ".$producto->metros_rollo." mts."; ?></span><?php endif; ?>
                        ...
                        <?php if ($producto->colores_producto != 'false') { ?>
                            ...
                            <span id="colours">
                                ...
                                <?php foreach ($colores as $color) { ?>
                                    <span class="thumbs_colors" title="<?php echo $color->nombre_color; ?>">
