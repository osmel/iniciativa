		...
		<div class="col-md-12 banncarrusel">
                <div id="banners">
					...
					<div class="container gnral">
						<h2>Catálogo</h2>
						<?php if($catals){
							foreach($catals as $catal){ ?>
								<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
									<span class="producto" id="producto_<?php echo $producto->pid; ?>">
									<?php
										switch ($catal->tipo_producto) {
											case 1:
												echo '<span class="producto-nuevo">NUEVO</span>';
												break;
											case 2:
									...
									?>
									<a href="<?php echo base_url(); ?>detalle/<?php echo $catal->slug_categoria.'/'.$catal->slug_producto.'/'.$catal->slug_modelo_producto; ?>">
										<?php if($catal->thumbs_producto){ ?>
											<img border="0" src="<?php echo base_url().'uploads/'.get_thumbnail($catal->thumbs_producto, 245); ?>" class="thumbnail_245_producto">
									</a>
									<?php }else{ ?>
										<img border="0" src="<?php echo base_url(); ?>img/no_image.jpg" class="thumbnail_245_producto">
									</a>
									<?php } ?>
									<h3 class="grid_titulo"><?php echo $catal->nombre_producto; ?></h3>
									<?php if($catal->modelo_producto) : ?><h4 class="grid_modelo"><?php echo strtoupper($catal->modelo_producto); ?></h4><?php endif; ?>
									<p class="grid_descripcion"><?php echo $catal->nombre_categoria; ?></p>
									<?php if($catal->precio_metro != 0) { ?>
		                                <p class="grid_precio">$<?php echo $catal->precio_metro; ?></p>
		                            <?php } else { ?>
		                                <p class="grid_precio">$<?php echo $catal->precio_rollo; ?></p>
		                            <?php } ?>
									<p class="add_carrito">
										<a onclick="showcarbutton(<?php echo $catal->pid; ?>);">
											<img border="0" src="<?php echo base_url(); ?>img/carrito_producto.png">
										</a>
									</p>
									<p class="botonadd">
										<a href="<?php echo base_url(); ?>detalle/<?php echo $catal->slug_categoria.'/'.$catal->slug_producto.'/'.$catal->slug_modelo_producto; ?>"><img border="0" src="<?php echo base_url(); ?>img/boton_addcar.png"></a>
									</p>
								</div>								
							<?php }
						}else{ ?>
