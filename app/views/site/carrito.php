			...
			<div id="view-content">
				...
				<div class="container carr">
					...
					<div class="table-responsive">
 					<table align="center" border="1" cellpadding="0" cellspacing="0" width="100%" class="carrito_producto table">
						<thead>
						<tr>
...
<div class="col-md-12" style="margin-top:30px;">	
	<div class="col-md-6">
	<input type="button" class="btn-colores" name="delete_cart" value="Vaciar Carrito" onclick="vaciarCarrito();">
	<?php if($this->cart->total_items() > 0) { ?>
		<input type="submit" class="btn-colores" name="update_cart" value="Actualizar Carrito" >
	<?php } ?>
	</div>
	<?php echo form_close(); ?>
	<div class="col-md-6 text-right">
		<input type="button" class="btn-colores" value="Confirmar pedido" name="confirmar_compra" onclick="confirmarCompra();">
	Total: <strong>$<?php echo /*$this->cart->total() . "--" .*/ $precio_total_compra; ?></strong>
	</div>
</div>
<div class="col-md-12">	
