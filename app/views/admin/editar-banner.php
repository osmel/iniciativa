			...
			<div id="view-content">
				...
				<?php echo form_open_multipart('admin/guardar_banner_editado', $attr); ?>
					...
					<span class="mini-bloque">
						...
						<img border="0" style="width:100%" src="<?php echo base_url().'uploads/banners/'.get_thumbnail( $banner->img_banner, 1170 ); ?>" />
					</span>
					<span class="mini-bloque">
					...
					<span class="mini-bloque final">
						...
						<?php if($banner->img_banner) : ?>
							<input type="hidden" name="img_banner" value="<?php echo get_thumbnail($banner->img_banner, 1170); ?>" >
						<?php endif; ?>
